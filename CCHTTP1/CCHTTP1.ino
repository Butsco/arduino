...
//------------------------------
//DEFINE SOME SHIZZLE - These are the interrupt and control pins
//------------------------------
...
#define BUFFER_SIZE           MAX_ACTION + MAX_PATH + 20  // Size of buffer for incoming request data. Since only the first line is parsed this needs to be as large as the maximum action and path plus a little for whitespace and HTTP version.
...
#define PIN 7 // pin voor neopixel
...
//-----------------
  Serial.begin(115200);
  Serial.println(F("Connection CC3000!\n")); 
